...
export const ForgotPassword = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      showToast(err.message || 'Student email not found', 'error');
    } finally {
      setSubmitting(false);
    }
  };
          ...
          {!sent ? (
            <>
              ...
              <p className="text-sm font-bold text-gray-500 mb-6 uppercase leading-tight">
                Enter your student email address to receive password override instructions.
              </p>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                ...
                >
                  {submitting ? 'Dispatching recovery...' : 'Send Recovery Link'}
            ...
            <div className="text-center py-4">
              ...
              <p className="text-sm font-bold text-gray-600 uppercase leading-relaxed mb-6">
                Recovery link simulated for student <span className="text-flatBlue font-black">{targetEmail}</span>.
              </p>
              
              <div className="flat-border bg-gray-50 p-4 mb-6 text-left">
                <h4 className="font-black text-xs uppercase text-black mb-1">Simulated Recovery Mode</h4>
                <p className="text-xs font-bold text-gray-500 leading-snug">
                  Click below to proceed to configuration, overriding the credentials for this email address.
                </p>
              </div>
